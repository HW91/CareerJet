...
function createPopup(currentFeature) {
  ...
  var popupDetails =
    '<div class="sidebar-content"><div class="sidebar-content-inner">' +
    ...
    currentFeature.properties[config.popupInfo[3]] +
    "</p>" +
    "<p class='sidebar-paragraph'>Salary: " +
    currentFeature.properties[config.popupInfo[4]] +
    "</p>" +
    "<p class='sidebar-paragraph'>Location: " +
    currentFeature.properties[config.popupInfo[5]] +
    "</p>" +
  ...
  new mapboxgl.Popup({ closeOnClick: true })
    ...
    // $("div.mapboxgl-popup").addClass("hidden");

    // $(".close-button").on("click", function () {
    //   $("div.mapboxgl-popup-tip").removeClass("hidden");
    //   console.log("desi")
    // });
}
    ...
    csv2geojson.csv2geojson(
      ...
      (err, data) => {
        data.features.forEach((data, i) => {
          ...
          data.properties.circleColor = "red";
        });
        geojsonData = data;
